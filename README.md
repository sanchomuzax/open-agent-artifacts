...
The workspace opens on a list/card catalog with previews. An opened artifact supports immutable version publishing, pin/unpin, visible or hidden comments, and highlighted comment anchors.
